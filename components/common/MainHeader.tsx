...
const MainHeader = () => {
  return (
    <div className="bg-[#fff] border-[0.5px] border-solid border-[#1E1E1E1A] z-[50] top-[50] fixed w-[100%] py-[5px] px-[50px] hidden lg:block">
        <header>
            <nav className="flex justify-between items-center text-[#181842]">
                ...
                <div className="flex gap-5 items-center">
                    ...
                    <div className="flex flex-col relative after:content-[''] after:absolute after:top-0 after:right-0 after:h-full after:w-[2px] after:bg-[#181842] pr-4">
                       ...
                       <Link href="/" className="text-[#fd9800] opacity-[0.8]">Call: +234 905 517 9713 </Link>
                    </div>

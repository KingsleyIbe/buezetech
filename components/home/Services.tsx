...
const services: Service[] = [
  ...
  },
  {
    ...
    actionLink: "https://forms.gle/9WDKqQassSS3kvC48",
    actionText: "Register for a course",
    target: "_blank",
    ...
    <section id="services" className="bg-[#ddd] bg-deco1 px-6 md:px-16 py-20 text-[#181842]">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-3/4 bg-white p-6 shadow-md]">
          ...
          <button type="button" className={`${styles.bookSessionBtn} mt-[50px]`}>
            <Link href={activeService.actionLink} target={activeService.target}>{activeService.actionText}</Link>
          </button>
        </div>
      </div>
    </section>
